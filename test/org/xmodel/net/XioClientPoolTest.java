...
public class XioClientPoolTest
{
  ...
  {
    GlobalSettings.getInstance().getModel().setExecutor( new LoggingExecutorWrapper( "server-model", 10));
...
//    Log.getLog( ExecutionResponseProtocol.class).setLevel( Log.all);
    ...
    GlobalSettings.getInstance().getModel().setExecutor( new LoggingExecutorWrapper( "client-model", 10));
