...
public class XslTransform implements ITransform
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xml.ITransform#transform(
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xml.ITransform#inverseTransform(
   * dunnagan.bob.xmodel.IModelObject, dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xml.ITransform#transform(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xml.ITransform#inverseTransform(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xml.ITransform#hasInverse()
   */
