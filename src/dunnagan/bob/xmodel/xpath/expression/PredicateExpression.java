...
public class PredicateExpression extends Expression implements IPredicate
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPredicate#evaluate(dunnagan.bob.xmodel.xpath.expression.IContext, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.Expression#evaluateBoolean(
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPredicate#addListener(dunnagan.bob.xmodel.xpath.expression.IExpressionListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPredicate#removeListener(dunnagan.bob.xmodel.xpath.expression.IExpressionListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPredicate#getPredicateListeners()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.RootExpression#notifyChange(
   * dunnagan.bob.xmodel.xpath.expression.IExpression, dunnagan.bob.xmodel.xpath.expression.IContext)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.RootExpression#requiresValueNotification(
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.Expression#handleException(
   * dunnagan.bob.xmodel.xpath.expression.IExpression, dunnagan.bob.xmodel.xpath.expression.IContext, 
   * java.lang.Exception)
   */
  @Override
