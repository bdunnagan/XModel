...
public class RootExpression extends Expression
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#internal_setParent(dunnagan.bob.xmodel.xpath.expression.IExpression)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getLocalScope()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.Expression#getVariableSource()
   */
  @Override
