...
public class LocalContext extends StatefulContext
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.StatefulContext#getParent()
   */
  @Override
  ...
  private static class QuietScope extends ContextScope
  {
    ...
    /* (non-Javadoc)
     * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#internal_set(java.lang.String, java.lang.Object)
     */
    @Override
