...
{
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IFunction#addArgument(
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#removeArgument(
   * dunnagan.bob.xmodel.xpath.expression.IExpression)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#internal_setParent(
   * dunnagan.bob.xmodel.xpath.expression.IExpression)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getParent()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getRoot()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#isAncestor(
   * dunnagan.bob.xmodel.xpath.expression.IExpression)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getArguments()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getArgument(int)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#setVariable(java.lang.String, java.lang.Boolean)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#setVariable(java.lang.String, java.lang.Number)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#setVariable(java.lang.String, java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#setVariable(java.lang.String, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#setVariable(java.lang.String, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getVariableSource()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getType(dunnagan.bob.xmodel.xpath.expression.IContext)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#requiresContext()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#evaluateNodes()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#evaluateString()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#evaluateNumber(
   * dunnagan.bob.xmodel.xpath.expression.IContext, double)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#evaluateString(
   * dunnagan.bob.xmodel.xpath.expression.IContext, java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#createSubtree(dunnagan.bob.xmodel.xpath.expression.IContext, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#query(java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#queryFirst()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#query(dunnagan.bob.xmodel.IModelObject, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#queryFirst(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#query(dunnagan.bob.xmodel.xpath.expression.IContext, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#queryFirst(dunnagan.bob.xmodel.xpath.expression.IContext)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#addListener(
   * dunnagan.bob.xmodel.xpath.expression.IContext, dunnagan.bob.xmodel.xpath.expression.IExpressionListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#removeListener(
   * dunnagan.bob.xmodel.xpath.expression.IContext, dunnagan.bob.xmodel.xpath.expression.IExpressionListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#addNotifyListener(
   * dunnagan.bob.xmodel.xpath.expression.IContext, dunnagan.bob.xmodel.xpath.expression.IExpressionListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#removeNotifyListener(
   * dunnagan.bob.xmodel.xpath.expression.IContext, dunnagan.bob.xmodel.xpath.expression.IExpressionListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#getListeners()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.expression.IExpression#notifyChange(
   * dunnagan.bob.xmodel.xpath.expression.IExpression, dunnagan.bob.xmodel.xpath.expression.IContext)
   */
