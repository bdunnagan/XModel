...
import dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope;
import dunnagan.bob.xmodel.xpath.variable.IVariableListener;
...
public class ContextScope extends AbstractVariableScope
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#get(java.lang.String, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#getAll()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#getType(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#isDefined(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#isBound(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#addListener(java.lang.String, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#removeListener(java.lang.String, 
   * dunnagan.bob.xmodel.xpath.expression.IContext, dunnagan.bob.xmodel.xpath.variable.IVariableListener)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#restore(dunnagan.bob.xmodel.memento.IMemento)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#revert(dunnagan.bob.xmodel.memento.IMemento)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#define(java.lang.String, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#set(java.lang.String, java.lang.Boolean)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#set(java.lang.String, dunnagan.bob.xmodel.IModelObject)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#set(java.lang.String, java.util.List)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#set(java.lang.String, java.lang.Number)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#set(java.lang.String, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.variable.AbstractVariableScope#toString()
   */
  @Override
