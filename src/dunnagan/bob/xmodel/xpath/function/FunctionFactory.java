...
import dunnagan.bob.xmodel.xpath.function.custom.*;
import dunnagan.bob.xmodel.xsd.SchemaFunction;
...
public class FunctionFactory implements IFunctionFactory
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.function.IFunctionFactory#register(java.lang.String, java.lang.Class)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.function.IFunctionFactory#register(java.lang.String, dunnagan.bob.xmodel.xpath.function.Function)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xpath.function.IFunctionFactory#createFunction(java.lang.String)
   */
  @SuppressWarnings("unchecked")
