...
import dunnagan.bob.xmodel.xpath.parser.generated.ParseException;
import dunnagan.bob.xmodel.xpath.parser.generated.XPathParser;
...
public class XPath extends AbstractPath implements IAxis
{
  ...
  /*
   * (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#compile(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#getRootExpression()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#clone(dunnagan.bob.xmodel.xpath.expression.RootExpression)
   */
