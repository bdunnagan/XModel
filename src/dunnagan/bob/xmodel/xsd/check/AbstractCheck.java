...
public abstract class AbstractCheck implements ICheck
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xsd.check.ICheck#validate(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xsd.nu.ICheck#getSchemaLocus()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.xsd.check.ICheck#getErrors(java.util.List)
   */
