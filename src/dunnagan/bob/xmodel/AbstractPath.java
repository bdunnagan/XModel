...
import dunnagan.bob.xmodel.path.ListenerChain;
...
import dunnagan.bob.xmodel.xpath.variable.VariableScope;
import dunnagan.bob.xmodel.xpath.variable.VariableSource;
...
public abstract class AbstractPath implements IPath, IAxis
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setParent(dunnagan.bob.xmodel.xpath.expression.IExpression)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#getParent()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#isAbsolute(dunnagan.bob.xmodel.xpath.expression.IContext)
   */
  ...
  /*
   * (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#evaluate(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#isNode(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#invertPath()
   */
  ...
  /*
   * (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#getPathElement(int)
   */
  ...
  /*
   * (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#length()
   */
  public int length()
  {
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#createSubtree(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#getVariableSource()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setVariable(java.lang.String, java.lang.Boolean)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setVariable(java.lang.String, java.lang.Number)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setVariable(java.lang.String, java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setVariable(java.lang.String, dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setVariable(java.lang.String, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#setVariable(java.lang.String, 
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#query(dunnagan.bob.xmodel.IModelObject, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#query(dunnagan.bob.xmodel.IModelObject, int, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#query(dunnagan.bob.xmodel.xpath.expression.IContext,
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#query(dunnagan.bob.xmodel.xpath.expression.IContext, int, 
   * java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#queryFirst(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#addPathListener(dunnagan.bob.xmodel.xpath.expression.IContext, 
   * dunnagan.bob.xmodel.IPathListener)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.IPath#removePathListener(dunnagan.bob.xmodel.IModelObject, 
   * dunnagan.bob.xmodel.IPathListener)
   */
