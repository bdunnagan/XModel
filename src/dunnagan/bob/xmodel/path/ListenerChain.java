...
public class ListenerChain implements IListenerChain
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#getListeners()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#getPath()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#getContext()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#getPathListener()
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#install(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#uninstall(dunnagan.bob.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#debugInstall(java.util.List, int)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#debugUninstall(java.util.List, int)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#debugIncrementalInstall(java.util.List, int)
   */
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.path.IListenerChain#debugIncrementalUninstall(java.util.List, int)
   */
