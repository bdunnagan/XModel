...
public class RuleBasedMatcher implements IXmlMatcher
{
  ...
  public static class ExpressionRule implements IRule
  {
    ...
    /* (non-Javadoc)
     * @see dunnagan.bob.xmodel.diff.RuleBasedMatcher.Rule#doesRuleApply(dunnagan.bob.xmodel.IModelObject, dunnagan.bob.xmodel.IModelObject)
     */
    public boolean doesRuleApply( IModelObject lhs, IModelObject rhs)
    {
    ...
    /* (non-Javadoc)
     * @see dunnagan.bob.xmodel.diff.RuleBasedMatcher.Rule#getMatcher()
     */
    public IXmlMatcher getMatcher()
    {
      return matcher;
