...
public class ConfiguredXmlMatcher extends DefaultXmlMatcher
{
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.diff.DefaultXmlMatcher#isList(dunnagan.bob.xmodel.IModelObject)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.diff.DefaultXmlMatcher#shouldDiff(dunnagan.bob.xmodel.IModelObject, boolean)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see dunnagan.bob.xmodel.diff.DefaultXmlMatcher#shouldDiff(dunnagan.bob.xmodel.IModelObject, java.lang.String, boolean)
   */
  @Override
