...
public class NamespaceConversion implements IXmlConversion
{
  ...
  /* (non-Javadoc)
   * @see org.xmodel.xml.IXmlConversion#setFactory(org.xmodel.IModelObjectFactory)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.xml.IXmlConversion#transform(org.xmodel.IModelObject, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.xml.IXmlConversion#transform(org.jdom.Element, java.util.List)
   */
