...
public class XmlModel
{
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#print(java.io.PrintStream)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#endTransaction()
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#getTransaction()
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#startTransaction()
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#restoreUpdate()
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#revertUpdate()
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#startUpdate(org.xmodel.IModelObject)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#setGlobalVariable(java.lang.String, boolean)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#setGlobalVariable(java.lang.String, double)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#setGlobalVariable(java.lang.String, java.util.List)
   */
  ...
  /* (non-Javadoc)
   * @see org.xmodel.IModel#setGlobalVariable(java.lang.String, java.lang.String)
   */
